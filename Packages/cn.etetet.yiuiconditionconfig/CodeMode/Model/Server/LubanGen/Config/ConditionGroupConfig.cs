...
namespace ET
{
    ...
    public sealed partial class ConditionGroupConfig : Luban.BeanBase
    {
        public ConditionGroupConfig(ByteBuf _buf) 
        {
            ...
            {int n0 = _buf.ReadSize(); CheckGroups = new System.Collections.Generic.List<EConditionGroupId>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { EConditionGroupId _e0;  _e0 = (EConditionGroupId)_buf.ReadInt(); CheckGroups.Add(_e0);}}
            OperationType = (EOperatorType)_buf.ReadInt();
            {int n0 = _buf.ReadSize(); CheckList = new System.Collections.Generic.List<ConditionCheckData>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { ConditionCheckData _e0;  _e0 = global::ET.ConditionCheckData.DeserializeConditionCheckData(_buf); CheckList.Add(_e0);}}
