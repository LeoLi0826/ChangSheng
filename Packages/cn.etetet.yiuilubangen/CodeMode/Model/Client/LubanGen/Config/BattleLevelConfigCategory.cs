...
namespace ET
{
    ...
    [Config]
    public partial class BattleLevelConfigCategory : Singleton<BattleLevelConfigCategory>, ILubanConfig
    {
        ...
        public Dictionary<int, BattleLevelConfig> GetAll() => _dataMap;
