...
{
    [EnableClass]
    public sealed partial class MapAIConfig : Luban.BeanBase
    {
        public MapAIConfig(ByteBuf _buf) 
        {
            Id = _buf.ReadInt();
        ...
        public static MapAIConfig DeserializeMapAIConfig(ByteBuf _buf)
        {
            return new MapAIConfig(_buf);
        }
        ...
        public const int __ID__ = 621144774;
