...
namespace ET
{
    ...
    public static partial class NumericDataExtend
    {
        ...
        /// 目标所有1-N的总和 最后计算0的结果
        /// </summary>
        public static void Copy(this NumericData self, params NumericData[] targets)
        {
            self.Copy(targets as IEnumerable<NumericData>);
        }
        ...
        /// 目标所有1-N的总和 最后计算0的结果
        /// </summary>
        public static void Copy(this NumericData self, params NumericDataComponent[] targets)
        {
            self.Copy(targets as IEnumerable<NumericDataComponent>);
        }
    }
}