...
namespace ET
{
    ...
    public static partial class NumericDataComponentSystem
    {
        ...
        /// 目标所有1-N的总和 最后计算0的结果
        /// </summary>
        public static void Copy(this NumericDataComponent self, params NumericData[] targets)
        {
            self.NumericData.Copy(targets);
        }
        ...
        /// 目标所有1-N的总和 最后计算0的结果
        /// </summary> 
        public static void Copy(this NumericDataComponent self, params NumericDataComponent[] targets)
        {
            self.NumericData.Copy(targets);
        }
