...
namespace ET.Client
{
    ...
    public static partial class LoginPanelComponentSystem
    {
        ...
        private static void UIBind(this LoginPanelComponent self)
        {
            ...
            self.u_EventAccountHandle = self.u_EventAccount.Add(self,LoginPanelComponent.OnEventAccountInvoke);
            self.u_EventPassword = self.UIBase.EventTable.FindEvent<UIEventP1<string>>("u_EventPassword");
            self.u_EventPasswordHandle = self.u_EventPassword.Add(self,LoginPanelComponent.OnEventPasswordInvoke);
