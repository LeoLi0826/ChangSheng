...
namespace ET.Client
{
    ...
    public partial class QuickItemPrefabComponent : Entity, IDestroy, IAwake, IYIUIBind, IYIUIInitialize
    {
        public const string PkgName = "QuickWindow";
        public const string ResName = "QuickItemPrefab";
        ...
        public const string OnEventSelectInvoke = "QuickItemPrefabComponent.OnEventSelectInvoke";
